        ...
        <div className="w-full bg-white/10 backdrop-blur-xl rounded-[3rem] p-8 shadow-2xl border border-white/20 relative">
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            <div className="relative">
              <div className="w-28 h-28 bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl transform -rotate-6">
                <Users className="w-14 h-14 text-white" strokeWidth={2} />
              </div>
              <div className="absolute -top-2 -right-2 w-11 h-11 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center shadow-xl">
            ...
            <p className="text-white/80 text-base leading-relaxed">
              Conheça pessoas autênticas com os mesmos valores e interesses que você
            </p>
          </div>
        </div>
      </div>
